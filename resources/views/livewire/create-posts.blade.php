<div x-data="data()" x-init="init()">
    <div class="w-100">
        <div class="d-flex justify-content-center">
            <div class="px-4 py-5 bg-white rounded shadow-sm w-95 w-md-85">
                <form class="row g-3" id="sub" wire:submit.prevent='createPost' action="" method="GET">
                    ...
                    <div class="co-12">
                        <div class="form-group" x-on:keyup="description_add">
                            ...
                            <textarea class="form-control {{ ! empty($errors->first('description')) ? "is-invalid input-error" : ""}}" name="description" id="description" required cols="30" rows="2" id="description"></textarea>
    ...
    <div wire:loading.class="d-flex" wire:target="createPost" class="spiner-wire">
        <div>
